...
// CALIBRATE
float PRateRoll = 0.75; float PRatePitch = 0.9; float PRateYaw = 2; // 0.6
float IRateRoll = 3.7; float IRatePitch = 4.0; float IRateYaw = 13; // 3.5
float DRateRoll = 0.03; float DRatePitch = 0.045; float DRateYaw = 0; // 0.03
